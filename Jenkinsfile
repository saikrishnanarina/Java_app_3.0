pipeline{
  ...
  stages{
      ...
      steps{
        script{
          sh 'curl -X PUT -u admin:Saikrishna@22 -T /opt/git/Java_app_3.0/target/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar "http://52.91.174.62:8082/artifactory/example-repo-local/my_pro-docker.jar"'
