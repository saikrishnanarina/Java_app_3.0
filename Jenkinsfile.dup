pipeline{
  ...
  stages{
      ...
      steps{
        script{
          sh 'curl -X PUT -u admin:Saikrishna@22 -T /opt/spring-cloud-kubernetes/kubernetes-configmap-reload/target/my_app.jar "http://54.234.98.97:8082/artifactory/example-repo-local/my_app.jar"'
